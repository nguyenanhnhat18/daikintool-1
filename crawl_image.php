<?php
	...
	$address = "2 erica cres heathmont vic 3135";
...
//VUT
	...
	$array2 = $arrays[8];
	$array3 = $arrays[9];
	$urls1 = explode('"', $array1);
	$urls2 = explode('"', $array2);
	$urls3 = explode('"', $array3);
	$url1 = $urls1[1];
	$url2 = $urls2[1];
	$url3 = $urls3[1];
	
//VUT
	$url1 = "https://www.realestate.com.au".$url1;
	$url2 = "https://www.realestate.com.au".$url2;
	$url3 = "https://www.realestate.com.au".$url3;
		...
		curl_setopt($ch, CURLOPT_ENCODING, 'gzip, deflate');
			...
			$headers[] = 'DNT: 1';
			$headers[] = 'Accept: */*';
			$headers[] = 'Referer: https://www.realestate.com.au/property/lookup?id=3268421&source=property-search-hp';
			$headers[] = 'TE: Trailers';
			$headers[] = 'Accept-Encoding: gzip, deflate, br';
			$headers[] = 'Connection: keep-alive';
			$headers[] = 'Upgrade-Insecure-Requests: 1';
